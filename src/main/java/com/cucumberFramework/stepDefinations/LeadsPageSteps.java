...
import com.cucumberFramework.pageobjects.LeadsPage;
...
public class LeadsPageSteps extends TestBase{


	LeadsPage leadsPage = new LeadsPage(driver);
	LeadsVerificationPage leadsVerificationPage=new LeadsVerificationPage(driver);
	WaitHelper waitHelper = new WaitHelper(driver);
	Logger log = LoggerHelper.getLogger(LeadsPageSteps.class);
	...
	public void i_enter_Street(String arg1) throws Throwable {
		LeadsData.setStreetAddress(arg1);
	...
	public void i_should_see_lead_creation_success_message() throws Throwable {
		...
		if (leadsVerificationPage.getLeadsCreationHeadersMsg().getText().contains(LeadsData.getFirstName())
			...
			org.testng.Assert.assertTrue(false, "leads creation method invalid"+ leadsVerificationPage.getLeadsCreationHeadersMsg().getText());
		}
	}
	...
	public void i_should_verify_leads_information() throws Throwable {
		...
		Assert.assertTrue(leadsVerificationPage.getStreetAddress().getText().contains(LeadsData.getStreetAddress()));
